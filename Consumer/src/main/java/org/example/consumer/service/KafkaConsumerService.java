...
public class KafkaConsumerService {
    ...
    @KafkaListener(topicPartitions = @TopicPartition(topic = "${spring.kafka.consumer.topic1}", partitions = {"0"}),
    ...
    @KafkaListener(topicPartitions = @TopicPartition(topic = "${spring.kafka.consumer.topic1}", partitions = {"1"}),
            groupId = "${spring.kafka.consumer.group-id1}")
    ...
    @KafkaListener(topicPartitions = @TopicPartition(topic = "${spring.kafka.consumer.topic1}", partitions = {"2"}),
            groupId = "${spring.kafka.consumer.group-id1}")
    ...
    @KafkaListener(topicPartitions = @TopicPartition(topic = "${spring.kafka.consumer.topic2}", partitions = {"0"}),
